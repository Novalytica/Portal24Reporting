...
d3.json("report_all.json", function(data) {
    ...
    radios.forEach(radio => radio.addEventListener("change", () => Plotly.newPlot("activity", data[parseInt(radio.value)], layout, config)));
  ...
  d3.json("report_all.json", function(data) {
    ...
    radios.forEach(radio => radio.addEventListener("change", () => Plotly.newPlot("series", data[parseInt(radio.value)], layout, config)));
